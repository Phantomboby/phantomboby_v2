...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By 𝐀𝐲𝐢𝐬𝐡𝐮-𝐌𝐰𝐨𝐥_𝐕𝟐' : process.env.ALL_CAPTION,
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://i.imgur.com/d4DIca6.jpeg' : process.env.GAN_IMAGE,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝐀𝐲𝐢𝐬𝐡𝐮-𝐌𝐰𝐨𝐥_𝐕𝟐' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'https://www.instagram.com/_aftrolls/' : process.env.SOCIAL_MEDIA,
    ...
    SUDO: process.env.SUDO === undefined ? '919947430792,0' : process.env.SUDO,
    DEBUG: DEBUG,
    COFFEEHOUSE_API_KEY: process.env.COFFEEHOUSE_API_KEY === undefined ? false : process.env.COFFEEHOUSE_API_KEY,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "919947430792-1627138839",
    SUPPORT2: "919947430792-1632403322",
    SUPPORT3: "919947430792-1621015274"
};
